...
<div>
    ...
    <div class="card-group">
        <div class="card col-md-4 bg-dark text-white rounded">
                <a href="{{route('addCustomerRoute')}}">
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <h4 class="mt-lg-2 mt-2 font-weight-bold text-white">Add new customer</h4>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex flex-row">
                                <a href="{{ route('editCustomerRoute', ['id'=>$c->customer_id]) }}" class="mr-2">
                                    <span class="btn btn-cyan btn-rounded icon-pencil"></span>
                                </a>
                                <form action="{{ route('deleteCustomerRoute', ['id'=>$c->customer_id]) }}" method="POST">
                        ...
                        @empty
                        <tr>
                            <td colspan="5">Please Insert Data</td>
                        </tr>
                        @endforelse
                    </tbody>
                    <tfoot>
