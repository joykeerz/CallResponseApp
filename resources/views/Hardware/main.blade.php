...
<div>
    ...
    <div class="card-group">
        <div class="card col-md-4 bg-dark text-white mr-auto rounded">
            <a href="{{route('addHardwareTypeRoute')}}">
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <h4 class="mt-lg-2 mt-2 font-weight-bold text-white" >Add hardware type</h4>
        ...
        <div class="card col-md-4 bg-dark text-white rounded">
                <a href="{{route('addHardwareRoute')}}">
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <h4 class="mt-lg-2 mt-2 font-weight-bold text-white">Add hardware</h4>
                    <div class="ml-auto mt-md-3 mt-lg-0">
                            <span class="opacity-7 text-muted"><i data-feather="plus" class="feather-icon"></i></span>
                        </div>
                    </div>
    ...
    <div class="card text-dark bg-white">
        <div class="card-header">
            <h4 class="mb-0 text-dark">Hardwares</h4>
        </div>
        <div class="card-body">
                ...
                <table id="zero_config" class="table table-striped table-bordered no-wrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$hardware->hardware_type_name}}</td>
                            <td class="d-flex flex-row">
                                <a href="{{ route('editHardwareRoute', ['id'=>$hardware->hardware_id]) }}" class="mr-2">
                                    <span class="btn btn-cyan btn-rounded icon-pencil"></span>
                                </a>
                                <form action="{{ route('deleteHardwareRoute', ['id'=>$hardware->hardware_id]) }}" method="POST">
