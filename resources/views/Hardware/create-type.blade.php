...
@section('content')
<h4 class="card-title mt-5">Add new hardware type</h4>
<div class="row">
    <div class="col-sm-12 col-md-6 col-lg-6">
        <div class="card">
            <form action="{{ route('createHardwareTypeRoute') }}" method="post">
                <div class="card-body">

                    <h4 class="card-title">type name</h4>
                    <div class="form-group">
                        <input type="text" class="form-control" name="tb_type_name">
                    </div>
