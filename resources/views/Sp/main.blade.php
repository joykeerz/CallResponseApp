...
@section('title')
Admin Dashboard | Service partner
@endsection
...
<div>
    ...
    <div class="card-group">
        <div class="card col-md-4 bg-dark text-white rounded">
                <a href="{{route('addSpRoute')}}">
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <h4 class="mt-lg-2 mt-2 font-weight-bold text-white">Add New SP</h4>
    ...
    <div class="card text-dark bg-white">
        <div class="card-header">
            <h4 class="mb-0 text-dark">Service partner</h4>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex flex-row">
                                <a href="{{ route('editSpRoute', ['id'=>$S->sp_id]) }}" class="mr-2">
                                    <span class="btn btn-cyan btn-rounded icon-pencil"></span>
                                </a>
                                <form action="{{ route('deleteSpRoute', ['id'=>$S->sp_id]) }}" method="POST">
                        ...
                        @empty
                        <tr>
                            <td colspan="4">please add data first</td>
                        </tr>
                        @endforelse
                    </tbody>
                    <tfoot>
