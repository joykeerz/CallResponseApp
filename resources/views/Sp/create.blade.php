...
@section('content')
<h4 class="card-title mt-5">Add new Service partner</h4>
<div class="row">
    <div class="col-sm-12 col-md-6 col-lg-6">
        ...
        @endif
        <div class="card">
            <form action="{{ route('createSpRoute') }}" method="post">
                <div class="card-body">

                    <h4 class="card-title">Sp name</h4>
                    <div class="form-group">
                        <input type="text" class="form-control" name="tb_sp_name" placeholder="Ex. PT. Mitra" value="{{ old('tb_bp_name') }}">
                    </div>

                    <h4 class="card-title">Sp Contact</h4>
                    <div class="form-group">
                        <input type="text" class="form-control" name="tb_sp_contact" placeholder="Insert Phone number Or Email"  value="{{ old('tb_bp_contact') }}">
                    </div>
