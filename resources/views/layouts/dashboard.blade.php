...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{ asset('/dist/assets/extra-libs/c3/c3.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/dist/assets/libs/chartist/dist/chartist.min.css')}}" rel="stylesheet">
    <link href="{{ asset('/dist/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet" />
    <!-- Custom CSS -->
    <link href="{{ asset('/dist/dist/css/style.min.css')}}" rel="stylesheet">
    @yield('customcss')
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="{{ route('home') }}">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="{{ asset('/dist/assets/images/yaksa/logo.jpg')}}" style="width: 12rem" alt="logo" class="dark-logo" />
                                <!-- Light Logo icon -->
                            ...
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                {{-- <img src="../assets/images/logo-text.png" alt="logotext" class="dark-logo" /> --}}
                                <!-- Light Logo text -->
                                {{-- <img src="../assets/images/logo-light-text.png" class="light-logo" alt="logotext" /> --}}
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
