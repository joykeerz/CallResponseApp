...
<div>
    ...
    <div class="card-group">
        <div class="card col-md-4 bg-dark text-white rounded">
                <a href="{{route('addBpRoute')}}">
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <h4 class="mt-lg-2 mt-2 font-weight-bold text-white">Add New BP</h4>
    ...
    <div class="card text-dark bg-white">
        <div class="card-header">
            <h4 class="mb-0 text-dark">Business partner</h4>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex flex-row">
                                <a href="{{ route('editBpRoute', ['id'=>$B->bp_id]) }}" class="mr-2">
                                    <span class="btn btn-cyan btn-rounded icon-pencil"></span>
                                </a>
                                <form action="{{ route('deleteBpRoute', ['id'=>$B->bp_id]) }}" method="POST">
