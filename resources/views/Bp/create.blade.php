...
@section('content')
<h4 class="card-title mt-5">Add new Business partner</h4>
<div class="row">
    <div class="col-sm-12 col-md-6 col-lg-6">
        ...
        @endif
        <div class="card">
            <form action="{{ route('createBpRoute') }}" method="post">
                <div class="card-body">

                    <h4 class="card-title">Bp name</h4>
                    <div class="form-group">
                        <input type="text" class="form-control" name="tb_bp_name" placeholder="Ex. PT. Mitra" value="{{ old('tb_bp_name') }}">
                    </div>

                    <h4 class="card-title">Bp Contact</h4>
                    <div class="form-group">
                        <input type="text" class="form-control" name="tb_bp_contact" placeholder="Insert Phone number Or Email"  value="{{ old('tb_bp_contact') }}">
                    </div>
